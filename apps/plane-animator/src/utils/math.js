...
// --- Agregados en plane-animator (no están en el original) ---

// Parte fraccionaria en [0,1), incluso para negativos. `mod1` es lo mismo pero
// se conserva por compatibilidad con el código copiado.
export const frac = (t) => t - Math.floor(t);

// Módulo real (no el resto con signo de JS).
export const mod = (a, n) => ((a % n) + n) % n;

// Ruido determinístico 0..1 a partir de un entero. Sin Math.random: el engine
// tiene que ser una función pura del tiempo (BRIEF §2.1).
