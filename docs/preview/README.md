...
Seis frames repartidos a lo largo de un ciclo, en 4:5 y en 9:16, para las tres
familias nuevas de `plane-animator`. Sirven para ver qué hace cada template sin
tener que abrir la tool.
...
numerados, que es lo que se ve entrando a la familia sin cargar imágenes.
